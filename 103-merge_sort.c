...
void merge_subarray(int *subarray, int *buff, size_t front, size_t mid,
		size_t back);
void merge_sort_recur(int *subarray, int *buff, size_t front, size_t back);
...
/**
 * merge_sort_recur - Implement the merge sort algorithm through recursion.
 * @subarray: A subarray of an array of integers to sort.
...
void merge_sort_recur(int *subarray, int *buff, size_t front, size_t back)
{
	...
	if (back - front > 1)
	{
		...
		merge_sort_recur(subarray, buff, front, mid);
		merge_sort_recur(subarray, buff, mid, back);
